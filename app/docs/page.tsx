...
export default function DocsPage() {
  return (
    <main className="relative min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top_left,rgba(62,128,241,0.10),transparent_20%),radial-gradient(circle_at_top_right,rgba(16,185,129,0.07),transparent_18%),radial-gradient(circle_at_70%_40%,rgba(139,92,246,0.06),transparent_16%),linear-gradient(180deg,#fdfbf6_0%,#f7f9ff_30%,#f8fcf7_60%,#f7f8ff_100%)] text-[#221f1b] selection:bg-blue-100">
