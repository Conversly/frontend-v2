...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col isolate">
      ...
      >
        <DialogContent className="sm:max-w-[500px] p-0 border-none shadow-2xl bg-card dark:bg-zinc-950 max-h-[90vh] overflow-y-auto">
          {dialogStep === "initial" && (
            <div className="p-8">
              ...
              <div className="grid gap-4 py-2">
                <div className="grid gap-2">
                  ...
                  <Input
                    ...
                    className={`h-12 text-base transition-all focus:ring-2 focus:ring-primary/30 ${inviteCodeError
              ...
              <div className="grid gap-6 py-2">
                <div className="grid gap-2">
                  ...
                  <Input
                    ...
                    className={`h-12 text-base transition-all focus:ring-2 focus:ring-primary/30 ${waitlistEmailError && touchedWaitlistEmail
                        ? "border-red-500 focus:border-red-500 focus:ring-red-500/30"
                        : "focus:border-primary"
                      }`}
                    onKeyDown={(e) => {
