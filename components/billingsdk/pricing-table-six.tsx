                    ...
                    {plans.map((plan, index) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="mb-8">
                                    <Button
                                        className={`bg-foreground text-primary-foreground hover:bg-foreground/90 border-primary-foreground h-12 w-full rounded-xl border font-medium transition-all duration-200 hover:cursor-pointer ${!plan.highlight ? "bg-foreground/80 text-primary-foreground hover:bg-foreground/70" : ""} `}
