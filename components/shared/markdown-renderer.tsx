...
const CodeBlock = ({
  ...
  const preClass = cn(
    "overflow-x-scroll rounded-md border bg-background/50 p-2 font-mono text-sm [scrollbar-width:none]",
    className
  )
...
const COMPONENTS = {
  ...
  ol: withClass("ol", "list-decimal pl-4 my-1"),
  ul: withClass("ul", "list-disc pl-4 my-1"),
  li: withClass("li", ""),
  table: withClass(
    "table",
  ...
  p: withClass("p", "whitespace-pre-wrap mb-1 last:mb-0"),
