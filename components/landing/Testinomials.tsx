...
const testimonials: Testimonial[] = [
  {
    ...
    company: "Podium",
    text: "Reliability and accelerating time to production often seem at odds, but with Verly's Agent Platform, we achieved both! Its ease of use and production-ready infrastructure allowed us to deploy our voice agents with confidence.",
    size: "lg",
    social: "linkedin",
  },
  {
  ...
  },
  {
    ...
    handle: "@Ola_dev01",
    text: "Verly has a lot to offer. One of the best platforms out there for real-time AI integrations and communication systems.",
    size: "md",
    social: "twitter",
  ...
  },
  {
    ...
    role: "CTO",
    company: "Retell AI",
    text: "We recently moved from a homegrown WebSocket stack to Verly Cloud, allowing us to flexibly integrate with telephony systems. This upgrade lets us deliver low latency calls to a global end-user base.",
    size: "lg",
    social: "linkedin",
  },
  {
  ...
  },
  {
    ...
    role: "Co-founder & CTO",
    company: "Playback",
    text: "Not having to worry about our ability to scale has been massive. We just have Verly worry about that scaling for us and have a predictable cost.",
    size: "md",
    social: "linkedin",
  },
  {
  ...
  },
  {
    ...
    text: "Verly enables us to very granularly fine-tune our agent code for every workflow and use any model provider. No other platform gives us this level of control.",
    size: "lg",
    social: "linkedin",
  },
  {
  ...
  },
  {
    ...
    company: "Spara",
    text: "Voice AI is at the heart of Spara's platform. Agents on Verly Cloud gives us effortless deployments and rock-solid hosting, enabling us to launch rapidly and iterate quickly.",
    size: "lg",
    social: "linkedin",
  },
  {
  ...
  },
  {
    ...
    role: "Co-Founder & CTO",
    company: "Polymath",
    text: "Low-latency video streaming is existential for any robotics company. We just couldn't have continued to build our platform if we didn't have Verly.",
    size: "md",
    social: "linkedin",
  },
];
