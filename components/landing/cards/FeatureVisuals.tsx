...
export const VoiceAgentVisual = () => (
  <div className="w-full h-full bg-gradient-to-br from-blue-50 to-indigo-50 flex items-center justify-center p-6 relative overflow-hidden">
    ...
    <div className="flex items-center gap-4 z-10 w-full max-w-[280px] justify-between">
      {/* Agent Avatar */}
      <div className="relative">
        <div className="w-16 h-16 bg-white rounded-2xl shadow-lg flex items-center justify-center relative z-10">
            ...
            {/* Headset indicator */}
            <div className="absolute -right-1 -top-1 w-6 h-6 bg-white rounded-full flex items-center justify-center shadow-sm border border-gray-100">
                 <Mic size={12} className="text-blue-500" />
            </div>
        </div>
        <div className="absolute inset-0 bg-blue-400 rounded-2xl blur opacity-20 transform translate-y-2"></div>
      </div>
      ...
      <div className="relative">
        ...
        <div className="absolute inset-0 bg-gray-400 rounded-2xl blur opacity-20 transform translate-y-2"></div>
      </div>
    </div>
...
export const WhatsAppVisual = () => (
  <div className="w-full h-full bg-gradient-to-br from-green-50 to-emerald-50 flex items-center justify-center p-4 relative overflow-hidden">
     {/* Phone Mockup */}
     <div className="w-48 bg-white rounded-[2rem] shadow-xl border-4 border-white relative overflow-hidden h-full max-h-[220px] flex flex-col">
        {/* Status Bar */}
...
export const WebsiteWidgetVisual = () => (
  <div className="w-full h-full bg-gradient-to-br from-indigo-50 to-purple-50 flex items-center justify-center p-6 relative">
     ...
     <div className="w-full max-w-[280px] bg-white rounded-lg shadow-lg border border-gray-100 overflow-hidden relative h-[180px]">
        {/* Browser Header */}
        ...
        <div className="absolute bottom-3 right-3 flex flex-col items-end gap-2 z-10">
             {/* Chat Bubble */}
             <div className="bg-white p-2.5 rounded-xl rounded-br-none shadow-lg border border-gray-100 mb-1 animate-bounce">
             ...
             {/* Widget Toggle */}
             <div className="w-10 h-10 bg-purple-600 rounded-full shadow-lg flex items-center justify-center text-white">
