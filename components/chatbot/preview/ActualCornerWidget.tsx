...
interface ActualCornerWidgetProps {
...
export function ActualCornerWidget({
  config,
  isOpen,
  setIsOpen,
  messages,
      ...
      {isOpen && (
        <div
          ...
          style={{
            [isLeft ? "left" : "right"]: "16px",
            bottom: "16px",
            width: config.chatWidth || "350px",
            height: config.chatHeight || "500px",
        ...
        >
          <Card
            className={cn(
              "h-full flex flex-col overflow-hidden border shadow-2xl",
