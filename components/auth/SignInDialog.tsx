  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[425px] p-0 overflow-hidden" showCloseButton={false}>
        <DialogHeader>
          <DialogTitle className="sr-only">Sign in to Verly</DialogTitle>
        </DialogHeader>
        <AnimatePresence>
          <div className="relative">
            ...
            >
              ...
              <h2 className="text-2xl font-semibold mb-2">Welcome to Verly</h2>
            ...
            <div className="p-6">
              ...
              <div className="space-y-4 pt-4 border-t">
                <p className="text-sm text-muted-foreground text-center">
                  Join innovative teams using Verly to create intelligent chatbots:
                </p>
